        ...
        {selectedTimetable === "My Timetable" && currentUser && (
              ...
              {userList.length > 0 ? (
                <ul>
                  {userList.map((user: User) => (
                    <li key={user.uuid}>
                      {<button className="user-link-Calendar" onClick={() => setSelectedUser(user)}>
                          <div className="user">
                            {user.photoUser ? (<img src={user.photoUser} alt={user.nameUser} className="user__profile-img-Calendar" />) : (
                              <img src="//ssl.gstatic.com/accounts/ui/avatar_2x.png" alt="profile-img" className="profile-img-card-Calendar" />
                            )}
                            <div className="user__info-Calendar">
                              <p className="user__name-Calendar">{user.nameUser} {user.surnameUser}</p>
                              <p className="user__username-Calendar">@{user.appUser}</p>
                            </div>
                          </div>
                        </button>}
                    </li>
          ...
          <div className="userCalendarContainer">
            {selectedUser ? (
              ...
              <div className="user_calendar">
                {otherUser.photoUser ? (
                  <img src={selectedUser.photoUser} alt={selectedUser.nameUser} className="user_profile-img" />
                ) : (
                  <img src="//ssl.gstatic.com/accounts/ui/avatar_2x.png" alt="profile-img" className="user_profile-img" />
                )}
                <div className="user__info">
                  <p className="user__ns">{selectedUser.nameUser} {selectedUser.surnameUser}</p>
