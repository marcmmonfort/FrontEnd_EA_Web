      ...
      <div className="activities-location-list">
        {activities.length > 0 ? (
          activities.map((activity) => (
            <div key={activity.uuid} className="activity-container" onClick={() => setSelectedActivity(activity)}>
          ...
          <div className="no-activities">
            ...
            <Link to="/createActivity" className="buttonGoToCreateActivity"> Create an Activity </Link>
          </div>
        )}
      </div>
    <Footer/>
